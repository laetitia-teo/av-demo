...
class MidiProcessor {
    constructor(workerScript, renderer) {
    ...
    handleWorkerMessage(event) {
        ...
        this.renderer.midiData = midiData
        switch (midiData.data[1]) {
            case 0:
                this.renderer.sliders[0] = midiData.data[2];
                break;
            case 1:
                this.renderer.sliders[1] = midiData.data[2];
                break;
            case 2:
                this.renderer.sliders[2] = midiData.data[2];
                break;
            case 3:
                this.renderer.sliders[3] = midiData.data[2];
                break;
            case 4:
                this.renderer.sliders[4] = midiData.data[2];
                break;
            case 5:
                this.renderer.sliders[5] = midiData.data[2];
                break;
            case 6:
                this.renderer.sliders[6] = midiData.data[2];
                break;
            case 7:
                this.renderer.sliders[7] = midiData.data[2];
                break;
            case 16:
                this.renderer.knobs[0] = midiData.data[2];
                break;
            case 17:
                this.renderer.knobs[1] = midiData.data[2];
                break;
            case 18:
                this.renderer.knobs[2] = midiData.data[2];
                break;
            case 19:
                this.renderer.knobs[3] = midiData.data[2];
                break;
            case 20:
                this.renderer.knobs[4] = midiData.data[2];
                break;
            case 21:
                this.renderer.knobs[5] = midiData.data[2];
                break;
            case 22:
                this.renderer.knobs[6] = midiData.data[2];
                break;
            case 23:
                this.renderer.knobs[7] = midiData.data[2];
                break;
        }
    }
...
class DemoApp {
    constructor(demos, defaultDemo='Spectrogram') {
        ...
        // midi
        this.midiData = null;
        this.sliders = new Uint8Array(8);
        this.knobs = new Uint8Array(8);
        // todo add additional buttons
        this.midiProcessor = new MidiProcessor('midiWorker.js', this);
        this.initializeMIDI();
    ...
    frame(t) {
        ...
        this.demo.frame(this.withCamera, {
            time:t/1000.0, xrMode: false, sliders:this.sliders, knobs:this.knobs,
            ...this.viewParams,
        });
    }
    ...
    onMIDISuccess(midiAccess) {
        ...
        for (let input of inputs) {
            input.onmidimessage = this.midiProcessor.handleMidiInput.bind(this.midiProcessor);
        }
    }
